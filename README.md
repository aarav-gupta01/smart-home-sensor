...
The custom register-level logic in `esp32/sensors/sths34pf80.py`, including the
register map, bit fields, and embedded-function page access, was generated with
Codex from the STHS34PF80 datasheet and then reviewed against that datasheet.
The STHS34PF80 polling code now in `esp32/main.py` was written after studying
the example usage in Adafruit's CircuitPython STHS34PF80 repository.
